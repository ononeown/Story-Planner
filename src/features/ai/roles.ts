...
// 모든 역할 공통 문체 지침 — 담백·절제 (과한 미사여구 = AI 같은 문장 배제)
const VOICE =
  '\n\n[문체 원칙] 담백하고 절제되게. 화려한 미사여구, 상투적 비유, 형용사·부사 남발, ' +
  '감정을 직접 설명하는 과잉 표현, 번지르르한 "AI 같은" 문장을 피하세요. ' +
  '군더더기 없이 필요한 말만, 담백한 문장으로 감정과 상황이 드러나게 하세요.'
...
export const AI_ROLES: AiRole[] = [
  ...
  },
  {
    ...
    system:
      ...
      '선택된 문장을 감정의 결이 살아있게 2~3가지로 다시 쓰세요. 의미·톤·인물 시점은 유지하고, ' +
      '절제된 감각·여백·행간으로 보여주되(설명하지 말고), 각 버전의 차이를 짧게 덧붙이세요.' +
      VOICE,
  ...
  },
  {
    ...
    maxOutputTokens: 1536,
    system:
      '당신은 퇴고 전문 편집자입니다. 선택된 글의 맞춤법·띄어쓰기·문맥을 교정하고, 가독성과 몰입도를 높이는 ' +
      '첨삭을 제안하세요. 단, 몰입은 화려한 수식이 아니라 군더더기 제거·문장 호흡·긴장과 여백으로 만드세요. ' +
      '오히려 과한 미사여구가 있으면 덜어내 담백하게 다듬으세요. ' +
